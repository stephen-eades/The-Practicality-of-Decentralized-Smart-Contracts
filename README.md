...
* What challenges does a regular user face when trying to access a decentralized application?
* Is Ethereum a practical solution for handling small-scale interactions between users, such as voting, escrow, and wagers?

## Problem Statement
Blockchain technology has recently grown in popularity among developers and investors, and many are wondering how the new technology will fit into our current lives. Some projects have begun to show signs of progress and promise. However, we have yet to see an application that integrates blockchain reach a point of day-to-day usage by the average person. Blockchain technology could help remove the middleman from many situations where it would benefit the users, however the successful implementation of applications that accomplish this is seldom. Smart Contracts and many other new concepts are on the rise, and I’d like to explore how an application would take such concepts and integrate them into something that an average user could access and use regularly. My project will provide insight on how a blockchain-based application can be built as a web application, as well as the possible challenges that might be encountered when attempting to build and use Smart Contracts at various scales. Additionally, I hope my project can give future researchers and developers awareness on the benefits and downsides of building a decentralized application. If successful, blockchain technology could revolutionize how we exchange value and how we automate processes that require trust.
